...
import com.restApi.Inventory.model.demodata;
...
//		return jdbcTemplate.query(List_Sql, new BeanPropertyRowMapper<InventoryDetail>(InventoryDetail.class));
	...
	@Override
	public List<demodata> getAllDetail() {
		List<demodata> inventoryDetails;
		String sql="select * from docs";
		RowMapper<demodata> rowmapper = new BeanPropertyRowMapper<demodata>(demodata.class);
		inventoryDetails = jdbcTemplate.query(sql, rowmapper);
		return inventoryDetails;
	}
}
